...
from openprocurement.litepublic.tests.base import test_tender_data, BaseWebTest, test_award, test_complaint, test_document
...
class TenderAwardResourceTest(BaseWebTest):
...
class TenderAwardComplaintResourceTest(BaseWebTest):
...
class TenderAwardComplaintDocumentResourceTest(BaseWebTest):
